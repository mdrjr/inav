...
static const OSD_Entry menuOsdElemsEntries[] =
{
    ...
    OSD_ELEMENT_ENTRY("CRSF TX POWER", OSD_CRSF_TX_POWER),
    OSD_ELEMENT_ENTRY("CRSF LQ", OSD_CRSF_LINK_QUALITY),
    OSD_ELEMENT_ENTRY("CRSF SNR", OSD_CRSF_SNR),
    OSD_ELEMENT_ENTRY("CRSF RSSI", OSD_CRSF_RSSI),
#endif
